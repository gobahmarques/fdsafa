        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-9">
                    ...
                    <form action="ptbr/organizacao/<?php echo $organizacao['codigo']; ?>/painel/liga/<?php echo $liga['codigo']; ?>/divisao/<?php echo $divisao['codigo']; ?>/novo-torneio/enviar/" method="post" enctype="multipart/form-data" onSubmit="return verificarSaldos();">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="codJogo" id="jogo" class="form-control" onChange="$('#regiao').focus();" required disabled>
                                            <?php
                                    ...
                                    <?php
                                        ...
                                        while($ocorrencias < 16){
                                            ?>
                                                ...
                                                <div class="form-group col-md-1">
                                                    <input type="text" class="form-control <?php echo "pontos".$contador; ?>" value="0" tabindex="<?php echo $contador+2; ?>" name="<?php echo "pontos".$contador; ?>">
                                                </div>
                                            <?php
                                            if($aux == 0){
                                                $contador += 8;
