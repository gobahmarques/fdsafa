                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="passoInscricao">
                                    <h3>Qual sua Conta?</h3><br>
                                    <div class="row">
                                        <div class="col-12 col-md-12">
                                            <input type="text" name="conta" class="form-control" placeholder="Qual seu nick no jogo?">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    * Não será possível alterar a conta ou time após o início do torneio.
                                </div>                            
                            </div> 
                            <div class="col-12 col-md-4">
