...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Nova Rifa
        <small>acumule mais recursos.</small>
      </h1>
      <ol class="breadcrumb">
                ...
                <div class="form-group col-md-6">
				  ...
				  <div class="form-group col-md-4">
					...
					<div class="input-group">
						...
						<input type="date" class="form-control" name="dataSorteio"> 
						<span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
						<input type="time" class="form-control" name="horaSorteio">
					  </div>
				</div>
				<div class="form-group col-md-2">
					<label for="">Preço Cupom em eSCoin (e$)*</label>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-dollar"></i></span>
						<input type="text" class="form-control" name="precoCupomCoin">
					  </div>
				</div>
				  
				  <div class="form-group col-md-2">
					<label for="">Preço Cupom em R$*</label>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-dollar"></i></span>
						<input type="text" class="form-control" name="precoCupom">
					  </div>
				</div>
				
				  <div class="form-group col-md-2">
				  	<label for="">Min. Cupons *</label>
					  <input type="number" class="form-control" name="minCupons" value="">
				  </div>
				  <div class="form-group col-md-2">
				  	<label for="">Max. Cupons</label>
					  <input type="number" class="form-control" name="maxCupons" value="">
				  </div>
				  <hr>
				  
				  <div class="form-group col-md-6">
				  	<label for="">Nome do Produto *</label>
					  <input type="text" class="form-control" placeholder="Informe o nome do produto a ser sorteado" name="nomeProduto">
				  </div>
				  <div class="form-group col-md-6">
				  	<label for="">Link Produto</label>
					  <input type="text" class="form-control" placeholder="Link Web do produto" name="linkProduto">
				  </div>
				  <div class="form-group col-md-2">
